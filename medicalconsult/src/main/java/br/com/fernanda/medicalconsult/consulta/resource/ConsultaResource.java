package br.com.fernanda.medicalconsult.consulta.resource;

import br.com.fernanda.medicalconsult.consulta.model.Consulta;
import br.com.fernanda.medicalconsult.consulta.service.ConsultaService;
...
//        return ResponseEntity.status(HttpStatus.CREATED).body(novaConsulta);
    ...
    public ResponseEntity<Consulta> atualizarConsulta(@RequestBody Consulta consulta, @PathVariable Long id){
        consulta.setIdConsulta(Math.toIntExact(id));
